...
$y101 = (($today - strtotime('2015-4-12'))/(60*60*24));
$y102 = (($today - strtotime('2015-4-6'))/(60*60*24)); //第1回大和チャレンジ
$y111 = (($today - strtotime('2015-7-12'))/(60*60*24));
$y112 = (($today - strtotime('2015-7-6'))/(60*60*24)); //第2回大和チャレンジ
...
$yamatohousyuu   = array("大海神" => $miho, "月光姫" => $kiho, "黄泉神" => $yaho, "義愛龍" => $hiho, "武刀神" => $hoho); //1
$yamatohousyuu2  = array("大海神" => $miho, "月光姫" => $kiho, "黄泉神" => $yaho, "義愛龍" => $hiho, "武刀神" => $hoho); //2
...
<table border="1">
<?php
echo "<br>大和チャレンジ第１回目<br>";
echo "開催日:2015年4/6~4/12  約";
echo round ($y101);
echo ('~');
echo round ($y102);
echo "日前<br>";
echo "<tr><th>ダンジョン</th><th>報酬</th></tr>";
   foreach ($yamatohousyuu as $k => $v) {
     echo "<tr><td>$k</td><td>$v</td></tr>";
   }
?>
</table>
...
<table border="1">
<?php
echo "<br>大和チャレンジ第2回目<br>";
echo "開催日:2015年7/6~7/12  約";
echo round ($y111);
echo ('~');
echo round ($y112);
echo "日前<br>";
echo "<tr><th>ダンジョン</th><th>報酬</th></tr>";
   foreach ($yamatohousyuu2 as $k => $v) {
     echo "<tr><td>$k</td><td>$v</td></tr>";
   }
?>
</table>
